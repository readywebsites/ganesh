...
function Donation() {
  ...
  return (
    <section id="donation" ref={sectionRef} className="relative py-20 lg:py-28 overflow-hidden bg-black/90">
      {/* Background Luxury Ambient Glows & Rays */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(212,175,55,0.07)_0%,transparent_65%)]" />
      <div className="pointer-events-none absolute -top-40 right-10 w-96 h-96 rounded-full bg-amber-500/10 blur-[120px]" />
      <div className="pointer-events-none absolute -bottom-40 left-10 w-96 h-96 rounded-full bg-gold/10 blur-[120px]" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[60px] items-center">
          ...
          <div ref={qrRef} className="order-1 lg:order-2 w-full flex justify-center">
            <div className="group relative w-full max-w-md p-[1px] rounded-3xl bg-gradient-to-b from-gold/60 via-amber-500/30 to-goldDark/50 shadow-[0_20px_60px_rgba(0,0,0,0.8)] transition-all duration-500 hover:shadow-[0_25px_70px_rgba(212,175,55,0.3)]">
              
              {/* Luxury Glass Card Inner */}
              <div className="relative rounded-[23px] bg-gradient-to-b from-neutral-900/90 via-black/95 to-neutral-950/95 p-6 sm:p-8 backdrop-blur-2xl text-center border border-amber-500/20 overflow-hidden">
                
                {/* Accent Corner Lines */}
                <div className="pointer-events-none absolute top-0 left-0 w-16 h-[2px] bg-gradient-to-r from-gold to-transparent" />
                <div className="pointer-events-none absolute top-0 left-0 w-[2px] h-16 bg-gradient-to-b from-gold to-transparent" />
                <div className="pointer-events-none absolute bottom-0 right-0 w-16 h-[2px] bg-gradient-to-l from-gold to-transparent" />
                <div className="pointer-events-none absolute bottom-0 right-0 w-[2px] h-16 bg-gradient-to-t from-gold to-transparent" />

                {/* Soft Golden Glow Ring behind QR */}
                <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full bg-gold/15 blur-3xl group-hover:bg-gold/25 transition-all duration-700" />

                {/* QR Display Frame with Floating Animation */}
                <div ref={qrImageRef} className="relative inline-block mb-6 z-10">
                  <div className="relative p-3 rounded-2xl bg-gradient-to-br from-amber-500/20 via-black to-gold/30 border border-gold/40 shadow-[0_10px_35px_rgba(212,175,55,0.25)]">
                    <Image
                      src="/images/qr-payment.jpg"
                      alt="Ganesh Mahotsav UPI QR Code - Raj Shukla"
                      width={240}
                      height={240}
                      className="w-52 h-52 sm:w-60 sm:h-60 object-contain rounded-xl shadow-md border border-amber-400/20"
                      priority
                    />
                ...
                <div className="space-y-3 z-10 relative">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-heading text-transparent bg-clip-text bg-gradient-to-r from-goldLight via-gold to-amber-200 tracking-wide font-medium">
                      Raj Shukla
                    </h3>
                    <p className="text-xs uppercase tracking-[0.25em] text-amber-200/70 font-light mt-0.5">
                      Official UPI Beneficiary
                    </p>
                  </div>

                  {/* UPI ID Pill with Copy Action */}
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-black/80 border border-gold/30 text-amber-100/90 shadow-inner group-hover:border-gold/60 transition-colors">
                    <span className="text-xs font-mono tracking-wide selection:bg-gold selection:text-black">
                      rajshukla1717-1@okhdfcbank
                    </span>
                    <button
                      type="button"
                      onClick={handleCopyUpi}
                      className="ml-1 text-gold hover:text-white transition-colors text-xs font-semibold px-2 py-0.5 rounded bg-gold/10 hover:bg-gold/30 border border-gold/40"
                      title="Copy UPI ID"
                    >
                      {copied ? '✓ Copied' : 'Copy'}
                    </button>
        ...
        {showModal && (
          ...
          >
            <div
              ref={modalRef}
              className="relative w-full max-w-md sm:max-w-lg my-auto rounded-3xl border border-gold/40 bg-gradient-to-b from-neutral-900/95 via-black/95 to-neutral-950/98 p-6 sm:p-8 text-white shadow-[0_25px_70px_rgba(0,0,0,0.95)] overflow-hidden"
            >
              {/* Luxury Ambient Glows inside Modal */}
              <div className="pointer-events-none absolute -top-24 -left-24 w-60 h-60 rounded-full bg-gold/15 blur-3xl" />
              <div className="pointer-events-none absolute -bottom-24 -right-24 w-60 h-60 rounded-full bg-amber-500/15 blur-3xl" />
              <div className="pointer-events-none absolute top-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-gold to-transparent" />
              ...
              <button
                ...
                className="absolute top-5 right-5 z-10 flex h-9 w-9 items-center justify-center rounded-full border border-gold/30 bg-black/60 text-amber-200/80 transition-all duration-300 hover:border-gold hover:bg-gold/20 hover:text-white hover:scale-110"
              ...
              <div className="relative z-10">
                <div className="text-center mb-6">
                  ...
                  <h3 className="font-heading text-2xl text-transparent bg-clip-text bg-gradient-to-r from-goldLight via-gold to-amber-200 font-light tracking-wide">
                ...
                {submitted ? (
                  <div className="text-center py-8 px-2 space-y-4">
                    <div className="relative inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-gold/30 via-amber-500/20 to-transparent border border-gold/50 shadow-[0_0_30px_rgba(212,175,55,0.4)] mb-2">
                      <span className="text-4xl">🙏</span>
                    </div>
                    
                    <h4 className="text-xl font-heading text-transparent bg-clip-text bg-gradient-to-r from-goldLight via-gold to-amber-200">
                    ...
                    <div className="pt-4">
                      <button
                        ...
                        className="btn-primary shimmer-btn px-8 py-3 rounded-xl text-xs font-medium tracking-widest uppercase bg-gradient-to-r from-goldDark via-gold to-goldLight text-black shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:shadow-[0_0_35px_rgba(212,175,55,0.6)] transition-all duration-300"
                      >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    {errorMsg && (
                      <div className="p-3 text-xs text-red-300 bg-red-950/70 rounded-xl border border-red-800/80 backdrop-blur-md">
                        {errorMsg}
                      </div>
                    )}

                    <div>
                      <label className="block text-xs font-medium text-amber-200/90 mb-1 tracking-wide">
                        Full Name *
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full bg-black/80 border border-gold/30 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold/50 transition-all duration-300"
                      />
                    </div>
